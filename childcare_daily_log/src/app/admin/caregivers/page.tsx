...
export default function CaregiverManagementPage() {
  ...
  const [editingCaregiver, setEditingCaregiver] =
    useState<CaregiverInfo | null>(null);
  ...
  const handleSave = async (caregiverData: CaregiverInfo) => {
    try {
      if (editingCaregiver && editingCaregiver.id) {
        ...
        showSuccess(
          "Caregiver created successfully! They can now register with their email."
        );
      }
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold text-center text-indigo-900 drop-shadow-lg adminTitle">
        Manage Caregivers
      </h1>
              ...
              >
                <div className="flex flex-row gap-2 items-center justify-center min-w-[160px]">
                  ...
                  <button
                    onClick={() =>
                      caregiver.id != null
                        ? setDeleteConfirmId(String(caregiver.id))
                        : undefined
                    }
      ...
      {deleteConfirmId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-auto">
          ...
          <div className="relative bg-white rounded-lg shadow-lg p-6 w-full max-w-xs flex flex-col items-center border-2 border-red-200">
            <p className="mb-4 text-center text-lg text-gray-900 font-semibold drop-shadow">
