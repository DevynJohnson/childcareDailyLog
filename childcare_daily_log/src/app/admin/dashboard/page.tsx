...
return (
  <div className="p-6">
    ...
    <div className="flex flex-col gap-8 max-w-5xl mx-auto">
      {/* Card 1: Manage Child Profiles, Caregivers, Invites */}
      <div className="card-gradient p-8 rounded-3xl shadow-lg flex flex-col w-full">
        <h2 className="mb-4 text-center">Create New Records</h2>
      ...
      <div className="card-gradient p-8 rounded-3xl shadow-lg flex flex-col w-full">
        <h2 className="mb-4 text-center">Caregiver and Parent Dashboards</h2>
        <div className="flex flex-wrap justify-center gap-6">
          <a
