  ...
  return (
    <div className="p-6">
      ...
      <button
        ...
        className="rounded-full px-6 py-3 font-medium transition-colors text-white text-center bg-gradient-to-r from-[var(--dark-indigo)] to-indigo-500 hover:from-indigo-600 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 shadow mt-2 mb-6"
      >
        Add Child
      </button>
      <div className="card-gradient p-6 rounded-3xl shadow-lg mb-8 overflow-visible">
        <table
          className="min-w-full bg-white text-center font-semibold border-2"
        ...
        >
          <thead>
            ...
            >
              <th className="p-2 border text-center" style={{ borderColor: 'var(--dark-indigo)' }}>First Name</th>
              <th className="p-2 border text-center" style={{ borderColor: 'var(--dark-indigo)' }}>Last Name</th>
              {/* Removed Birthday and Age columns */}
              <th className="p-2 border text-center" style={{ borderColor: 'var(--dark-indigo)' }}>Parent/Guardians</th>
              <th className="p-2 border text-center" style={{ borderColor: 'var(--dark-indigo)' }}>Allergies</th>
              <th className="p-2 border text-center" style={{ borderColor: 'var(--dark-indigo)' }}>Notes</th>
          ...
          <tbody>
            {children.map((child) => (
              <tr key={child.id} className="border-t" style={{ borderColor: 'var(--dark-indigo)' }}>
                <td className="p-2 border" style={{ borderColor: 'var(--dark-indigo)' }}>{child.firstName}</td>
                <td className="p-2 border" style={{ borderColor: 'var(--dark-indigo)' }}>{child.lastName}</td>
                ...
                <td className="p-2 border space-x-2" style={{ borderColor: 'var(--dark-indigo)' }}>
                  <button
