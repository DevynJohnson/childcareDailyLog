...
function ChildrenAdminPage() {
  ...
  const [openParentInfo, setOpenParentInfo] = useState<{
    ...
    <div className="p-6">
      ...
      >
        <thead>
          ...
          >
            <th
              className="p-2 border text-center w-40"
              style={{ borderColor: "var(--dark-indigo)" }}
            >
              Name
            </th>
            ...
            <th
              className="p-2 border text-center w-32"
              style={{ borderColor: "var(--dark-indigo)" }}
            >
              Allergies
            </th>
          ...
          {children.map((child) => (
            ...
            >
                      ...
                      return (
                        <div key={parent.email} className="relative">
                          <button
                            ...
                            onClick={() =>
                              setOpenParentInfo((prev) => ({
                                ...prev,
                                [childKey]: isOpen ? null : parent.email,
                              }))
                            }
                          >
              ...
              <td
                ...
                style={{ borderColor: "var(--dark-indigo)" }}
              >
                {child.allergies ? child.allergies : "None provided"}
              </td>
              <td
                className="p-2 border"
                style={{ borderColor: "var(--dark-indigo)" }}
              ...
              >
                <div className="flex flex-row gap-2 items-center justify-center min-w-[160px]">
                  ...
                  <button
                    onClick={() =>
                      child.id != null
                        ? setDeleteConfirmId(String(child.id))
                        : undefined
                    }
                ...
                {deleteConfirmId === String(child.id) && (
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
                    <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-xs flex flex-col items-center">
                      <p className="mb-4 text-center text-lg text-gray-900 font-semibold">
